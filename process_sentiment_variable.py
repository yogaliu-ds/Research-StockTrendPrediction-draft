import pandas as pd
from sentiment_variable import datatype_process, title_classifier, content_classifier, \
    summation_short_term, summation_mid_term, summation_long_term, final_adjustment
